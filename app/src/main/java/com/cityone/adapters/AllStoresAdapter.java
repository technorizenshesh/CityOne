...
public class AllStoresAdapter extends RecyclerView.Adapter<AllStoresAdapter.StoreHolder> {

    Context mContext;
    ArrayList<ModelStores.Result> storeList;

    public AllStoresAdapter(Context mContext, ArrayList<ModelStores.Result> storeList) {
