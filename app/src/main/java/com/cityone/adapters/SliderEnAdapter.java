...
public class SliderEnAdapter extends SliderViewAdapter<SliderEnAdapter.MyViewHolder> {
    Context context;
    ArrayList<BannerModel.Result> arrayList;

    public SliderEnAdapter(Context context, ArrayList<BannerModel.Result> arrayList) {
