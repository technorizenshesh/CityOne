...
public class AdapterStoreItemCat extends RecyclerView.Adapter<AdapterStoreItemCat.StoreCatHolder> {

    Context mContext;
    ArrayList<ModelStoreDetails.Result.Restaurant_sub_category> storeList;
    int index = 0;

    public AdapterStoreItemCat(Context mContext, ArrayList<ModelStoreDetails.Result.Restaurant_sub_category> storeList) {
    ...
    @NonNull
    @Override
    public AdapterStoreItemCat.StoreCatHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AdapterStoreItemCat.StoreCatHolder(binding);
    }

    @Override
    public void onBindViewHolder(@NonNull AdapterStoreItemCat.StoreCatHolder holder, int position) {
